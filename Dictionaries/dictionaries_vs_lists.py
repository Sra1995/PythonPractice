...
# or we can use dictionary rather than a list like
# it is better to use dictionary when you are planning to use a specific element

host_addresses = {"router": "192.168.1.1", "localhost": "127.0.0.1", "google":"8.8.8.8"}

# Set is used when you want to store a bunch of elements and be certain that they're only present once
